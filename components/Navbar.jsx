...
const Navbar = () => {
  return (
    <>
      <div className="navbar bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-4 flex-col xl:flex-row">
        <div className="flex-1">
          <a className="btn btn-ghost font-bold italic text-xl">Aiman Arif</a>
        </div>
        <div className="flex-col lg:flex-row lg:flex-none gap-2">
